...
public:
    ...
    void admission() {
        ...
        count++;
        rollNo = 100000 + count;
        cout << "Admission successfull" << endl;
        cout << "Roll number of new student is: " << rollNo << endl;
    }
...
int main() {
    ...
    do {
        cout << "1. New Admission" << endl << "2. Marks-entry" << endl; 
        cout<< "3. Marksheet display" << endl << "4. Display total no of students" << endl;
        cout<< "5. Exit" << endl << "Enter choice" << endl;
        cin>>ch;
        switch (ch) {
            case 1:
